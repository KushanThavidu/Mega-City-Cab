...
<body>
    <div class="container">
        ...
        <h2 class="form-title" style="color: #FFB800;">Forgot Password</h2>
        <form method="post" action="forgotpassword" class=register-form id=register-form >
            <div class="input-row">
            ...
            <div class="input-group">
                ...
                <input type="text" name="password" placeholder="Password" id="password" 
                       value="<%= request.getAttribute("password") != null ? request.getAttribute("password") : "" %>" readonly>
            </div>
            <button type="submit" class="btn btn-primary">Show Password</button>
            <button type="button" class="btn btn-secondary" onclick="window.location.href='login.jsp'">Login</button>
        </form>
    </div>
    <!-- SweetAlert JS -->
    ...
    <script>
        ...
        window.onload = function() {
            ...
            if (status === "success") {
                showPopup("Show Password uccessful!", "success");
            } else if (status === "unsuccess") {
                showPopup("Show Password failed. Please try again.", "error");
            } else if (status === "passwordMismatch") {
                showPopup("Details do not match. Please try again.", "error");
